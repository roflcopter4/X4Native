...
inline int on(char const *name, void (*callback)())
{
...
inline int on(char const *name, void (*callback)(void *))
{
    return detail::g_api->subscribe(
...
inline int on(char const *name, void (*callback)(X4NativeFrameUpdate const *))
{
    return detail::g_api->subscribe(
...
inline int on(char const *name, void (*callback)(char const *))
{
    return detail::g_api->subscribe(
...
inline int on(char const *name, void (*callback)(X4RadarChangedEvent const *))
{
    return detail::g_api->subscribe(
...
inline int on(char const *name, X4NativeEventCallback callback, void *userdata = nullptr)
{
...
inline void raise(char const *name, void *data = nullptr)
{
...
inline int raise_lua(char const *name, char const *param = nullptr)
{
...
inline int bridge_lua_event(char const *lua_event, char const *cpp_event)
{
