...
// Verified: build 607242 (X4_FrameTick @ 0x140F58520: xmmword_146AFA800 = GAME_TIME,
//   +8 = RAW_TIME, xmmword_146AFA810 = REAL_TIME guarded by IsGamePaused_0,
//   qword_146AFA828 = SPEED_MULT)
#define X4_RVA_FRAME_GAME_TIME     0x06AFA800  /* double — game_time (scaled by speed multiplier) */
#define X4_RVA_FRAME_RAW_TIME      0x06AFA808  /* double — always-incrementing wall time */
#define X4_RVA_FRAME_REAL_TIME     0x06AFA810  /* double — unpaused real time */
#define X4_RVA_FRAME_SPEED_MULT    0x06AFA828  /* double — game speed multiplier (1.0/2.0/5.0/10.0) */

// FIND: Same X4_FrameTick decompile — a1+568 frame_counter, a1+576 fps_timer, a1+584 fps.
// Verified: build 607242 (unchanged from 603098)
...
// Verified: build 607242 (see docs/rev/GAME_LOOP.md)
...
// Verified: build 607242 (universal prefix + Object-specific fields)
...
// Verified: build 607242. See docs/rev/PRODUCTION_MODULES.md §5.3.
...
//   GetBuildProcessorEstimatedTimeLeft @ 0x1401509D0 dispatches into
//   sub_14034FB70. Inside, look for `if ( *(double *)(a1 + 600) <= -0.9999 )` — the
...
//   sub_14034FB70 (same chain as above). After reading +0x258 as `result`, it
...
//   GetCurrentBuildProgress body sub_14034FC80. Top-of-function guard reads
...
//
// @verified v9.00 build 607242 (RelationData offset confirmed by binary analysis at
// FactionRelation_GetFloat RVA 0x0030F500: `mov rcx, [rcx+280h]`)
#ifdef __cplusplus
...
// Verified: build 607242 (3 consistent callers — qword_146C8D2F8)
#define X4_RVA_COMPONENT_REGISTRY       0x06C8D2F8  /* void** — g_ComponentRegistry */
...
//
// Layout verified 2026-04-29 by binary analysis of SetFactionRelationToPlayerFaction
// (build 607242, RVA 0x0017FBB0): `mov rdx, cs:qword_146C8D550` (explicit memory
...
// Verified: build 607242 — see docs/rev/FACTION_RELATIONS.md §2.2.
#define X4_RVA_FACTION_REGISTRY         0x06C8D550  /* void** — pointer slot for g_FactionRegistry */
...
// Verified: build 607242 (universal prefix + Object-specific)
//
...
// Verified: build 607242 (price_factor 0x790 confirmed in SetContainerGlobalPriceFactor
//   @ 0x1401B7730: v4[484] = result; spawntime @ 0x6E0 inferred — re-verify if
...
//   SetContainerGlobalPriceFactor @ 0x1401B7730 decompile. After the IsClassID(111)
...
// Verified: build 607242 (offset 0x790 unchanged from 606138)
...
// @verified v9.00 build 607242 (offsets carry over; sunlight getter address drifts)
...
// Verified: build 607242 (no further shift vs 606138 — GetComponentClass @ 0x140151A50: vtable+4544 for GetClassID,
//   AddCluster @ 0x14013DD50: vtable+4552 for IsClassID,
//   SetObjectRadarVisible_Action @ 0x140B96270: vtable+4560 for IsDerived (call qword [rax+11D0h]),
//   PauseProductionModule @ 0x14017CDF0: vtable+5640 for player-faction getter)
...
// ---- Component ID decomposition (ComponentRegistry_Find @ 0x1400CE910, build 607242) ----
...
// ---- Galaxy global ----
// WARNING: data address changes between builds. Re-verify on game updates.
// FIND: Decompile GetPlayerID (PE export). First [rip+disp] load in .data/0x03CB range.
// Verified: build 607242 (GetPlayerID @ 0x14016C1C0 reads qword_143CB6218+560=player ptr;
//   AddCluster @ 0x14013DD50 reads qword_143CB6218+552=galaxy ptr)
#define X4_RVA_GAME_UNIVERSE            0x03CB6218  /* void** — g_GameUniverse */
...
// Verified: build 607242 (algorithm constants, stable across builds)
...
// Verified: build 607242 (predicted from GAME_UNIVERSE - 0x98 = 0x03CB6218 - 0x98)
#define X4_RVA_SESSION_SEED             0x03CB6180  /* uint64* — g_SessionSeed */
...
// Verified: build 607242 (enum values unchanged, addresses may drift)
...
// Verified: build 607242 (ExportMapConstructionPlan @ 0x14018BEA0 uses qword_146C8D578;
//   AddCluster @ 0x14013DD50 calls MacroRegistry_Lookup with qword_146C8D3F0)
#define X4_RVA_CONSTRUCTION_PLAN_DB     0x06C8D578  /* void** — g_ConstructionPlanRegistry (RB-tree at +16) */
#define X4_RVA_MACRO_REGISTRY           0x06C8D3F0  /* void*  — g_MacroRegistry (BST at +64) */
...
// Controllable::CreateDynamicInterior (0x140416320, build 607242) selects a door connection from
...
// Allocate via GameAlloc, init via PlanEntry_Construct (0x140D13F90, build 607242).
...
// counter at 0x143891970 if id==0 on construct, build 607242).
//
// See docs/rev/CONSTRUCTION_PLANS.md for full documentation.
// NOTE: struct layout — update when game build changes.
// Verified: build 607242 (PlanEntry_Construct @ 0x140D13F90 decompiled,
...
// Verified: build 607242 (radar_visible offset 0x400 confirmed in SetObjectRadarVisible_Action @ 0x140B96270)
...
// Verified: build 607242 (LEA r12,??_7RadarVisibilityChangedEvent@U@@6B@ at 0x140B9631B)
#define X4_RADAR_EVENT_VTABLE_RVA           0x02B4F7F8  /* const U::RadarVisibilityChangedEvent::`vftable' */
